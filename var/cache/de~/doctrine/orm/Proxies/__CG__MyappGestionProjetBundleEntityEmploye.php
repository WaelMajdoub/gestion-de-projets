 ...
 */
class Employe extends \Myapp\GestionProjetBundle\Entity\Employe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'id', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'nom', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'prenom', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'date', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'sexe', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'pays', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Employe' . "\0" . 'departement'];
        }
