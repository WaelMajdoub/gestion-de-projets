...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/projet')) {
            ...
            // recherche_projet
            if ($pathinfo === '/projet/search') {
                return array (  '_controller' => 'Myapp\\FrontBundle\\Controller\\ProjetController::rechercheProjetAction',  '_route' => 'recherche_projet',);
            }
        ...
        // front_employe
        if ($pathinfo === '/employe') {
            return array (  '_controller' => 'Myapp\\FrontBundle\\Controller\\EmployeController::indexAction',  '_route' => 'front_employe',);
        }
