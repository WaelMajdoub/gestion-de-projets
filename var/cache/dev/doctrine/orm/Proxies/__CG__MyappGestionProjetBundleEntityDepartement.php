 ...
 */
class Departement extends \Myapp\GestionProjetBundle\Entity\Departement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Departement' . "\0" . 'id', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Departement' . "\0" . 'nom', '' . "\0" . 'Myapp\\GestionProjetBundle\\Entity\\Departement' . "\0" . 'employe'];
        }
