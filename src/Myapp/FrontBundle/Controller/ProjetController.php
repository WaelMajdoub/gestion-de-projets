...
use Myapp\FrontBundle\Form\ProjetType;
...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('FrontBundle:projet:index.html.twig', array(
            'projets' => $projets,
        ));
    }
    ...
    {
        $projet = new Projet();
        $form = $this->createForm('Myapp\FrontBundle\Form\ProjetType', $projet);
        ...
        return $this->render('FrontBundle:projet:new.html.twig', array(
            'projet' => $projet,
    ...
    public function showAction(Projet $projet)
    {
        ...
        return $this->render('FrontBundle:projet:show.html.twig', array(
            'projet' => $projet,
    ...
    public function rechercheProjetAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $projets = $em->getRepository('GestionProjetBundle:Projet')->findProjectByKeyword($keyword);
    ...
    {
        $deleteForm = $this->createDeleteForm($projet);
        $editForm = $this->createForm('Myapp\GestionProjetBundle\Form\ProjetType', $projet);
        ...
        return $this->render('FrontBundle:projet:edit.html.twig', array(
            'projet' => $projet,
